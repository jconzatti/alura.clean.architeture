...
type
   ...
   private
      FDDD: String;
      FNumero: String;
    function ObterTelefoneFormatado: String;
   ...
   public
      ...
      property ValorFormatado: String read ObterTelefoneFormatado;
   end;
...
function TTelefone.ObterTelefoneFormatado: String;
begin
   Result := Format('(%s)%s', [FDDD, FNumero]);
end;
